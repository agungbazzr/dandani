    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Tambah Data Tukang</h3>
          ...
          <form class="form-horizontal" role="form" method="POST" action="{{ route('tukang.store') }}">
            {{ csrf_field() }}
			  ...
			  <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
	            ...
	            <div>
	              <input id="image" maxlength="255" type="text" class="form-control " name="image" value="{{ old('image') }}" required autofocus autocomplete="off">

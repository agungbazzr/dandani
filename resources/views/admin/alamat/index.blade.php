      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
            <a href="{{ route('alamat.create') }}" class="btn btn-info"><i class="fa fa-plus-circle"></i> Tambah</a>
          </div>
        </div>
        <div class="card-body">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  <a href="{{ url('alamat/destroy')}}/{{ $data->id }}" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')" class="btn btn-primary"><i class="fa fa-trash fa-fw"></i> Hapus</a> |
                  <a href="{{ url('alamat/edit')}}/{{ $data->id }}" class="btn btn-success"><i class="fa fa-edit"></i> Edit</a>
                </td>
              </tr>
              <?php $no++; ?>
              @endforeach
